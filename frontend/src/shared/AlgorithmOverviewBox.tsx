            ...
            <section className="algorithm-overview">
                <div className="algorithm-overview__content">
                    ...
                    <p>
                        ...
                        point at a time. δ denotes the shortest distance found so far.
                    </p>
                    <p>
                        Previously processed points remain relevant only while they are less than δ to the left of the current point. These points form the
                        active set and lie inside the δ-wide active window. The active set is kept ordered by y-coordinate.
                    </p>

                    <p>
                        For the current point, only active points with y-coordinates between current.y - δ and current.y + δ need to be checked.
                        Together with the horizontal restriction of the active window, this defines a δ × 2δ candidate window to the left of the current
                        point.
                    </p>
                    ...
                    <p>
                        ...
                        can lie in the candidate window without being closer than δ, so only a constant number of distance checks is required per point.
