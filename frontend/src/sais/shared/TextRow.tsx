                ...
                </text>
                {
                    [...props.source].map((char, index) => (
                        <g key={index}>
                            ...
                            />
                            <text
                                id={`text_row0_text_${index}`}
                                key={`text_row0_text_${index}`}
